# Test kPa to psi conversion was added for my Exceeds Expectations.
...
def test_water_column_height():
    ...
    assert water_column_height(0, 10.0) == approx(7.5)
    assert water_column_height(25.0, 0) == approx(25.0)
...
def test_pressure_loss_from_pipe():
    ...
    assert pressure_loss_from_pipe(0.048692, 200.00, 0, 1.75) == approx(0, abs=0.001)
    assert pressure_loss_from_pipe(0.048692, 200.00, 0.018, 0.00) == approx(0, abs=0.001)
...
def test_pressure_conversion():
    ...
    assert kPa_to_psi(300) == approx(43.5114, abs=0.001)
